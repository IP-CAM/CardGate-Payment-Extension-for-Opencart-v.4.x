...
$_['text_cardgatesofortbanking']        = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="/extension/cardgate/admin/view/image/payment/cardgate.png" alt="CardGate SofortBanking" title="CardGate SofortBanking" style="border: 1px solid #EEEEEE;" /></a>';
$_['text_success']                      = 'Success: You have modified CardGate SofortBanking account details!';
