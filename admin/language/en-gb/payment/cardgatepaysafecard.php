...
$_['text_cardgatepaysafecard']                = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="/extension/cardgate/admin/view/image/payment/cardgate.png" alt="CardGate Paysafecard" title="CardGate Paysafecard" style="border: 1px solid #EEEEEE;" /></a>';
$_['text_success']                      = 'Success: You have modified CardGate Paysafecard account details!';
