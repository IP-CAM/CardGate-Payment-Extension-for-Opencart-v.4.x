...
$_['text_cardgateonlineueberweisen']                = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="/extension/cardgate/admin/view/image/payment/cardgate.png" alt="CardGate OnlineÜberweisen" title="CardGate OnlineÜberweisen" style="border: 1px solid #EEEEEE;" /></a>';
$_['text_success']                      = 'Success: You have modified CardGate OnlineÜberweisen account details!';
