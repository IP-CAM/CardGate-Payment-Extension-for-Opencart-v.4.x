...
$_['text_cardgatepaysafecash']                = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="/extension/cardgate/admin/view/image/payment/cardgate.png" alt="CardGate Paysafecash" title="CardGate Paysafecash" style="border: 1px solid #EEEEEE;" /></a>';
$_['text_success']                      = 'Success: You have modified CardGate Paysafecash account details!';
