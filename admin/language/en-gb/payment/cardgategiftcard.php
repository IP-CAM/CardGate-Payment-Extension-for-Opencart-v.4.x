...
// Heading
$_['heading_title']                     = 'CardGate Giftcard';
$_['text_extension']                    = 'Extensions';

// Text
$_['text_payment']                      = 'Extensions';
$_['text_cardgategiftcard']                = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="/extension/cardgate/admin/view/image/payment/cardgate.png" alt="CardGate Giftcard" title="CardGate Giftcard" style="border: 1px solid #EEEEEE;" /></a>';
$_['text_success']                      = 'Success: You have modified CardGate Giftcard account details!';
