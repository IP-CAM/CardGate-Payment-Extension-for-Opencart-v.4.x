...
// Heading
$_['heading_title']                     = 'CardGate Banktransfer';
$_['text_extension']                    = 'Extensions';

// Text
$_['text_payment']                      = 'Extensions';
$_['text_cardgatebanktransfer']                = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="/extension/cardgate/admin/view/image/payment/cardgate.png" alt="CardGate Banktransfer" title="CardGate Banktransfer" style="border: 1px solid #EEEEEE;" /></a>';
$_['text_success']                      = 'Success: You have modified CardGate Banktransfer account details!';
