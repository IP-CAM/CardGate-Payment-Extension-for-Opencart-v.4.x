...
$_['text_cardgateplus']      = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="/extension/cardgate/admin/view/image/payment/cardgate.png" alt="Cardate Bancontact" title="Cardgate Bancontact" style="border: 1px solid #EEEEEE;" /></a>';
