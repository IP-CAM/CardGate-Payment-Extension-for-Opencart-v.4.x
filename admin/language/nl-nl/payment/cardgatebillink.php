...
$_['text_success']           = 'Gelukt: U heeft uw Cardgate Billink instellingen gewijzigd!';
$_['text_cardgateplus']      = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="/extension/cardgate/admin/view/image/payment/cardgate.png" alt="Cardate Billink" title="Cardgate Billink" style="border: 1px solid #EEEEEE;" /></a>';
$_['text_cardgatebillink']    = $_['text_cardgateplus'];
